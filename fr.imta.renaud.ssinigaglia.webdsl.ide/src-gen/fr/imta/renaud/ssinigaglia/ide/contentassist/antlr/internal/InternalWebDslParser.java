...
public class InternalWebDslParser extends AbstractInternalContentAssistParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_STRING", "RULE_ID", "RULE_INT", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'LINK'", "'BUTTON'", "'IMAGE'", "'SEARCH_FIELD'", "'DIV'", "'check'", "'uncheck'", "'PARENT'", "'FIRST'", "'LAST'", "'ALL'", "'TEXT'", "'chrome'", "'firefox'", "'safari'", "'edge'", "'ie'", "'CHECKBOX'", "'COMBO_BOX'", "'A'", "'LABEL'", "'ID'", "'CLASS'", "'ALT'", "'VALUE'", "'HREF'", "'TITLE'", "'test'", "'{'", "'open_browser'", "'}'", "'PROCEDURE'", "'('", "'){'", "'PROC:'", "')'", "'go'", "'select'", "'store'", "'in'", "'count'", "'set'", "':'", "'verify'", "'contains'", "'equals'", "'VAR:'", "'click'", "'PAGE'"
    };
    ...
    public final void rule__LinkButtonSelection__Alternatives_3() throws RecognitionException {
        ...
        try {
            ...
            if ( ((LA4_0>=11 && LA4_0<=15)||(LA4_0>=28 && LA4_0<=29)||LA4_0==49||LA4_0==52||LA4_0==59) ) {
                alt4=1;
            }
            else if ( (LA4_0==58) ) {
                alt4=2;
    ...
    public final void rule__ComboboxSelection__Alternatives_3() throws RecognitionException {
        ...
        try {
            ...
            if ( ((LA7_0>=11 && LA7_0<=15)||(LA7_0>=28 && LA7_0<=29)||LA7_0==49||LA7_0==52||LA7_0==59) ) {
                alt7=1;
            }
            else if ( (LA7_0==48) ) {
                alt7=2;
    ...
    public final void rule__Core__Group__5__Impl() throws RecognitionException {
        ...
        try {
            ...
            do {
                ...
                if ( ((LA21_0>=11 && LA21_0<=15)||(LA21_0>=28 && LA21_0<=29)||LA21_0==45||LA21_0==47||LA21_0==59) ) {
                    alt21=1;
                }
    ...
    public final void rule__Procedure__Group__5__Impl() throws RecognitionException {
        ...
        try {
            ...
            do {
                ...
                if ( ((LA22_0>=11 && LA22_0<=15)||(LA22_0>=28 && LA22_0<=29)||LA22_0==45||LA22_0==47||LA22_0==59) ) {
                    alt22=1;
                }
    ...
    public final void rule__LinkButtonSelection__Group__3__Impl() throws RecognitionException {
        ...
        try {
            ...
            do {
                ...
                if ( ((LA23_0>=11 && LA23_0<=15)||(LA23_0>=28 && LA23_0<=29)||LA23_0==49||LA23_0==52||(LA23_0>=58 && LA23_0<=59)) ) {
                    alt23=1;
                }
    ...
    public final void rule__GeneralSelection__Group__3__Impl() throws RecognitionException {
        ...
        try {
            ...
            do {
                ...
                if ( ((LA24_0>=11 && LA24_0<=15)||(LA24_0>=28 && LA24_0<=29)||LA24_0==49||LA24_0==52||LA24_0==59) ) {
                    alt24=1;
                }
    ...
    // InternalWebDsl.g:2156:1: rule__CheckboxSelection__Group__3__Impl : ( ( rule__CheckboxSelection__Alternatives_3 )* ) ;
    public final void rule__CheckboxSelection__Group__3__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalWebDsl.g:2160:1: ( ( ( rule__CheckboxSelection__Alternatives_3 )* ) )
            // InternalWebDsl.g:2161:1: ( ( rule__CheckboxSelection__Alternatives_3 )* )
            {
            // InternalWebDsl.g:2161:1: ( ( rule__CheckboxSelection__Alternatives_3 )* )
            // InternalWebDsl.g:2162:2: ( rule__CheckboxSelection__Alternatives_3 )*
            {
             before(grammarAccess.getCheckboxSelectionAccess().getAlternatives_3()); 
            // InternalWebDsl.g:2163:2: ( rule__CheckboxSelection__Alternatives_3 )*
            loop25:
            do {
                int alt25=2;
                int LA25_0 = input.LA(1);

                if ( ((LA25_0>=11 && LA25_0<=17)||(LA25_0>=28 && LA25_0<=29)||LA25_0==49||LA25_0==52||LA25_0==59) ) {
                    alt25=1;
                }
                ...
                switch (alt25) {
            	case 1 :
            	    // InternalWebDsl.g:2163:3: rule__CheckboxSelection__Alternatives_3
            	    {
    ...
    public final void rule__ComboboxSelection__Group__3__Impl() throws RecognitionException {
        ...
        try {
            ...
            do {
                ...
                if ( ((LA26_0>=11 && LA26_0<=15)||(LA26_0>=28 && LA26_0<=29)||(LA26_0>=48 && LA26_0<=49)||LA26_0==52||LA26_0==59) ) {
                    alt26=1;
                }
    ...
    // InternalWebDsl.g:3698:1: rule__CheckboxSelection__GeneralActionsAssignment_3_0 : ( ruleGeneralAction ) ;
    public final void rule__CheckboxSelection__GeneralActionsAssignment_3_0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalWebDsl.g:3702:1: ( ( ruleGeneralAction ) )
            // InternalWebDsl.g:3703:2: ( ruleGeneralAction )
            {
            // InternalWebDsl.g:3703:2: ( ruleGeneralAction )
            // InternalWebDsl.g:3704:3: ruleGeneralAction
            {
    ...
    // InternalWebDsl.g:4010:1: rule__AssertContains__ValueAssignment_3 : ( RULE_STRING ) ;
    public final void rule__AssertContains__ValueAssignment_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalWebDsl.g:4014:1: ( ( RULE_STRING ) )
            // InternalWebDsl.g:4015:2: ( RULE_STRING )
            {
            // InternalWebDsl.g:4015:2: ( RULE_STRING )
            // InternalWebDsl.g:4016:3: RULE_STRING
            {
    ...
    // InternalWebDsl.g:4025:1: rule__AssertEquals__C1Assignment_0 : ( ruleComparable ) ;
    public final void rule__AssertEquals__C1Assignment_0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalWebDsl.g:4029:1: ( ( ruleComparable ) )
            // InternalWebDsl.g:4030:2: ( ruleComparable )
            {
            // InternalWebDsl.g:4030:2: ( ruleComparable )
            // InternalWebDsl.g:4031:3: ruleComparable
            {
    ...
    // InternalWebDsl.g:4040:1: rule__AssertEquals__C2Assignment_2 : ( ruleComparable ) ;
    public final void rule__AssertEquals__C2Assignment_2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalWebDsl.g:4044:1: ( ( ruleComparable ) )
            // InternalWebDsl.g:4045:2: ( ruleComparable )
            {
            // InternalWebDsl.g:4045:2: ( ruleComparable )
            // InternalWebDsl.g:4046:3: ruleComparable
            {
    ...
    // InternalWebDsl.g:4055:1: rule__Comparable__VarAssignment_0_1 : ( ruleVar ) ;
    public final void rule__Comparable__VarAssignment_0_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalWebDsl.g:4059:1: ( ( ruleVar ) )
            // InternalWebDsl.g:4060:2: ( ruleVar )
            {
            // InternalWebDsl.g:4060:2: ( ruleVar )
            // InternalWebDsl.g:4061:3: ruleVar
            {
    ...
    // InternalWebDsl.g:4070:1: rule__Comparable__HtmlElementAssignment_1_1 : ( ruleHtmlElement ) ;
    public final void rule__Comparable__HtmlElementAssignment_1_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalWebDsl.g:4074:1: ( ( ruleHtmlElement ) )
            // InternalWebDsl.g:4075:2: ( ruleHtmlElement )
            {
            // InternalWebDsl.g:4075:2: ( ruleHtmlElement )
            // InternalWebDsl.g:4076:3: ruleHtmlElement
            {
    ...
    // InternalWebDsl.g:4085:1: rule__Comparable__AttributeAssignment_1_2 : ( ruleAttribute ) ;
    public final void rule__Comparable__AttributeAssignment_1_2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalWebDsl.g:4089:1: ( ( ruleAttribute ) )
            // InternalWebDsl.g:4090:2: ( ruleAttribute )
            {
            // InternalWebDsl.g:4090:2: ( ruleAttribute )
            // InternalWebDsl.g:4091:3: ruleAttribute
            {
    ...
    public static final BitSet FOLLOW_10 = new BitSet(new long[]{0x0800A2003000F800L});
    public static final BitSet FOLLOW_11 = new BitSet(new long[]{0x0800A0003000F802L});
    ...
    public static final BitSet FOLLOW_16 = new BitSet(new long[]{0x0000003F803C0000L});
    public static final BitSet FOLLOW_17 = new BitSet(new long[]{0x0C1202003000F800L});
    public static final BitSet FOLLOW_18 = new BitSet(new long[]{0x0C1200003000F802L});
    public static final BitSet FOLLOW_19 = new BitSet(new long[]{0x081202003000F800L});
    public static final BitSet FOLLOW_20 = new BitSet(new long[]{0x081200003000F802L});
    public static final BitSet FOLLOW_21 = new BitSet(new long[]{0x081202003003F800L});
    public static final BitSet FOLLOW_22 = new BitSet(new long[]{0x081200003003F802L});
    public static final BitSet FOLLOW_23 = new BitSet(new long[]{0x081302003000F800L});
    public static final BitSet FOLLOW_24 = new BitSet(new long[]{0x081300003000F802L});
