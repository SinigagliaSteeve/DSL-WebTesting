		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getProgramAccess().getCoreAssignment(), "rule__Program__CoreAssignment");
					...
					put(grammarAccess.getStoreActionAccess().getVarAssignment_3(), "rule__StoreAction__VarAssignment_3");
					...
					put(grammarAccess.getTypeSelectionAccess().getValueAssignment_0_2(), "rule__TypeSelection__ValueAssignment_0_2");
